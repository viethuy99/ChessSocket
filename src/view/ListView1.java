...
public class ListView1 extends javax.swing.JFrame {
...
//            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ArrayList<User> haha = new ArrayList<>();
        haha.add(new User("HuyTran", "123"));
        setListUser(haha);
...
//        setListUser(haha);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListView1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListView1(new User("Huy","123")).setVisible(true);
            }
        });
    }
...
//        System.out.println("Nhay vao send data");
        try {
            ...
            System.out.println("m"+row0+col0+row1+col1);
            dos.writeUTF("m"+row0+col0+row1+col1);
        } catch (Exception ex) {
            ex.printStackTrace();
            return false;
        }
